...
public class AppHelper {
    ...
    public static AndroidDriver appAutomation() throws MalformedURLException, InterruptedException {
        ...
        dc.setCapability(AndroidMobileCapabilityType.APP_PACKAGE, "com.sil.dids.dids");
